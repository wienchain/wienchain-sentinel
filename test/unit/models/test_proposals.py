...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://gov.wienchain.com/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://gov.wienchain.com/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        url="https://gov.wienchain.com/wine-n-cheeze-party",
...
def test_proposal_is_valid(proposal):
    from wienchaind import WienchainDaemon
    import wienchainlib
    wienchaind = WienchainDaemon.from_wienchain_conf(config.wienchain_conf)
    ...
    # this is actually the Wienchain foundation multisig address...
    ...
    proposal.url = 'http://gov.wienchain.com/dean-miller 5493'
    assert proposal.is_valid() is False

    proposal.url = 'http://wienchaincentralisé.org/dean-miller-5493'
    assert proposal.is_valid() is True

    proposal.url = 'http://wienchaincentralisé.org/dean-миллер-5493'
    assert proposal.is_valid() is True
    ...
    # gibberish URL
    proposal.url = wienchainlib.deserialise('')
    assert proposal.is_valid() is False
    ...
    # ============================================================
    # ensure proposal can't request negative wienchain
    # ============================================================
...
def test_approved_and_ranked(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_wienchaind(wienchaind, item)
